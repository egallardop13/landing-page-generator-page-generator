...
export default function Hero5() {
  return (
    <section className="text-gray-400 bg-gradient-to-b from-blue-300 to-amber-100 body-font">
          ...
          <div className="flex w-full md:justify-start justify-center items-end">
            <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
              ...
              <input
                ...
                id="hero-field"
                name="hero-field"
                className="w-full bg-gray-600 rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-amber-900 focus:bg-transparent focus:border-amber-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
